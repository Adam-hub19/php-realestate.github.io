...
if(isset($_POST['sub']))
 {
  ...
  {	
    $id=$_GET['id'];
    $testinomiallist = $admin->getEditAgentDetailsById($id);
}
//print_r($subadmin);
//exit(0);
                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                    <div class="panel-body">
                                        ...
                                        <input type="hidden" name="id" id="id" value="<?php echo $testinomiallist['agent_id']; ?>">
                                        ...
                                        <div class="form-group"><label class="col-lg-3 control-label">Designation</label>
                                            <div class="col-lg-5"><textarea placeholder="Designation" name="designation" id="designation" class="form-control" required><?php echo $testinomiallist['designation']; ?></textarea></div>
                                        </div>
                                        										
                                        
										<div class="form-group"><label class="col-lg-3 control-label">Agent Old Image</label>
                                            <div class="col-lg-5"><img src="images/<?php echo $testinomiallist['image'];?>" height="200" width="200"></div>
                                        </div>
                                        
                                        <div class="form-group"><label class="col-lg-3 control-label">Agent New Image</label>
                                            <div class="col-lg-5"><input type="file" placeholder="Agent New Image" name="image" class="form-control" ></div>
                                        </div>
										
                                       <div class="form-group"><label class="col-lg-3 control-label">Facebook</label>
                                            <div class="col-lg-5"><input type="text" placeholder="Facebook" name="facebook" value="<?php echo $testinomiallist['facebook']; ?>"  id="facebook" class="form-control" required></div>
                                        </div>
										<div class="form-group"><label class="col-lg-3 control-label">Twitter</label>
                                            <div class="col-lg-5"><input type="text" placeholder="Twitter" name="twitter" value="<?php echo $testinomiallist['twitter']; ?>"  id="twitter" class="form-control" required></div>
                                        </div>
										<div class="form-group"><label class="col-lg-3 control-label">Linkdin</label>
                                            <div class="col-lg-5"><input type="text" placeholder="Linkdin" name="linkdin" value="<?php echo $testinomiallist['linkdin']; ?>"  id="linkdin" class="form-control" required></div>
                                        </div>
										<div class="form-group"><label class="col-lg-3 control-label">Instagram</label>
                                            <div class="col-lg-5"><input type="text" placeholder="Instagram" name="instagram" value="<?php echo $testinomiallist['instagram']; ?>"  id="instagram" class="form-control" required></div>
                                        </div>
