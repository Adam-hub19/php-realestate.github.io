...
//   
    ...
    $testinomial = $admin_obj->getAllAgent($start,$records_per_page);
  
    $count=$admin_obj->countAllAgent();
    //
    $next = $page + 1;    
    $prev = $page - 1;
        ...
        $option.= '<div class="table-responsive">
                                ...
                                if(is_array($testinomial) && count($testinomial) > 0)
                            {
                                     ...
                                     {  
										...
										<td>'.$record['linkdin'].'</td>
										<td>'.$record['instagram'].'</td>
										<td>'.$status.'</td>
                                        <td>'.$record['add_date'].'</td>
                                        <td><a href="edit-agent.php?id='.$record['agent_id'].'&page='.$page.'"><i class="fa fa-pencil"></i></a></td>
                                        <td><a href="" onclick="deletetestinomial('.$record['agent_id'].','.$page.');return false;"><i class="fa fa-trash"></i></a></td>
                                        ...
                                        <div class="row mail-header">
                                            ...
                                            <div class="col-md-6">
                                                <div class="pull-right tooltip-show">
                                                    ...
                                                    <a href="add-agent.php" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title=""><i class="fa fa-plus"></i></a>
